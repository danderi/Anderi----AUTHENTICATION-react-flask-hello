        ...
        try {
            ...
            if (response.success) {
                ...
                if (response.error === "User not found.") {
                    ...
                    setErrors(prevErrors => ({ ...prevErrors, password: "" })); // Clear password error message if exists
                } else if (response.error === "Invalid password.") {
                    setErrors({ password: "Invalid password. Please try again." });
                    setErrors(prevErrors => ({ ...prevErrors, email: "" })); // Clear email error message if exists
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button type="submit" className="btn btn-primary w-100 mt-3" aria-label="Login">Login</button>
